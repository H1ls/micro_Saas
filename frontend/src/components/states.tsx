  ...
  return (
    <section className="flex h-full min-h-[620px] items-center justify-center rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">The first MVP flow renders deterministic insight and charts from the backend fallback.</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="flex h-full min-h-[620px] items-center justify-center rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-slate-600">Preparing insight and chart data.</p>
      </div>
    </section>
  );
}
